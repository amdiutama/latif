            ...
            with Bool(max_workers=35) as kirim:
                ...
                for email in id:
                    ...
                    if(len(str(name.lower()))>=6):
                        memek=[name.lower(),name.lower()+'123',name.lower()+'12345']
                    elif(len(str(name.lower()))<=2):
                        memek=[name.lower(),name.lower()+'123',name.lower()+'1234']
                    elif(len(str(name.lower()))<=3):
                        memek=[name.lower(),name.lower()+'1234',name.lower()+'12345']
                    else:
                        memek=[name.lower(),name.lower()+'123',name.lower()+'1234',name.lower()+'12345']
                    try:
